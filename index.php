...
<body>
<h1>My most interesting movies</h1>
<a href="year" class="category">My interesting movies By Year</a><br />
<a href="box" class="category">My interesting movies By International Box Office Totals</a>
<h3 id="filmtitle"></h3>
<div id="films">
